    ...
    return (
        <div ref={ref} className={`relative inline-block text-left ${className}`}>
            <div className="ml-2 mt-0 flex">
                <button
                    className="font-sm shadow-xs inline-flex items-center rounded-md border border-gray-300 bg-white px-[12px] py-[10px] text-sm font-medium leading-[16px] text-black shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-gray-800 focus:ring-offset-2 sm:px-[8px]"
                        ...
                        {!state.sent ? (
                            <>
                                ...
                                >
                                    ...
                                    <div className="mt-[12px] flex h-[32px] w-full justify-end">
                                        <button
                                            className={`w-[70px] items-center rounded-md text-sm font-medium uppercase text-white hover:bg-black/80 ${
                                                state.loading ? "bg-black/80" : "bg-black"
                                            }`}
                            ...
                            <div className="mt-[10px] flex h-[140px] flex-col items-center justify-center">
                                ...
                                <span className="mb-3 block text-sm font-normal text-zinc-600">
                                    Thanks for your contribution in improving the product.
                                </span>
                            </div>
                        )}
                    </div>
